...
# df_Darknet -> LEN TRAIN 50000, LEN_VALIDATION 30000
#
...
n_c = 100
while n_c > 28 or n_c <27:
    qPca_fitted = pca.fit(train, theta_estimate=True, eps_theta=0.35, p=n_components,
                          estimate_all=True, delta=0.1, eps=10, true_tomography=True, stop_when_reached_accuracy=True,
                          eta=0.01, faster_measure_increment=1000)
